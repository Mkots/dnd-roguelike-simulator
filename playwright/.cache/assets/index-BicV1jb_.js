const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CombatLog-CJYS_S3_.js","assets/jsx-runtime-BTSpV5jZ.js","assets/FighterCard-DqC8GRKa.js","assets/avatars-kf3-nYud.js","assets/GameTitle-CGbYrHsJ.js","assets/lucide-react-CUqtwrv2.js","assets/HeroPreview-BYUck3rC.js","assets/PlayerStats-y2fyDmd3.js"])))=>i.map(i=>d[i]);
...
const _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_CombatLog_CombatLog = () => __vitePreload(() => import('./CombatLog-CJYS_S3_.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.CombatLog);
const _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_FighterCard_FighterCard = () => __vitePreload(() => import('./FighterCard-DqC8GRKa.js'),true              ?__vite__mapDeps([2,1,3]):void 0).then((mod) => mod.FighterCard);
const _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_GameTitle_GameTitle = () => __vitePreload(() => import('./GameTitle-CGbYrHsJ.js'),true              ?__vite__mapDeps([4,1,5]):void 0).then((mod) => mod.GameTitle);
const _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_HeroPreview_HeroPreview = () => __vitePreload(() => import('./HeroPreview-BYUck3rC.js'),true              ?__vite__mapDeps([6,1,5,3]):void 0).then((mod) => mod.HeroPreview);
const _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_PlayerStats_PlayerStats = () => __vitePreload(() => import('./PlayerStats-y2fyDmd3.js'),true              ?__vite__mapDeps([7,1,5]):void 0).then((mod) => mod.PlayerStats);
__pwRegistry.initialize({ _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_CombatLog_CombatLog,
  _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_FighterCard_FighterCard,
  _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_GameTitle_GameTitle,
  _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_HeroPreview_HeroPreview,
  _home_runner_work_dnd_roguelike_simulator_dnd_roguelike_simulator_src_components_PlayerStats_PlayerStats });

export { getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-BicV1jb_.js.map
